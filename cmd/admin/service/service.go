...
import (
	...
	"TEFS-BE/pkg/admin/console_shell"
	"TEFS-BE/pkg/admin/console_shell/file_server"
	shellLabServer  "TEFS-BE/pkg/admin/console_shell/laboratory_server/server"
...
func main() {
	...
	// shell console api
	http.HandleFunc("/api/ws", console_shell.ConsoleShell)
	http.HandleFunc("/api/shell/upload_file", file_server.ReceiveFileToShellServer)
	http.HandleFunc("/api/shell/download_file", file_server.DownFileShellServer)

	// shell tefs client api
	http.HandleFunc("/api/experiment/tree", shellLabServer.GetExperimentTree)
	http.HandleFunc("/api/experiment/create", shellLabServer.CreateExperiment)
	http.HandleFunc("/api/experiment/delete", shellLabServer.DeleteExperiment)
